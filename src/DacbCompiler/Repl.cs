...
namespace dacbCompiler
{
    ...
    internal abstract class Repl
    {
        ...
        private sealed class SubmissionView
        {
            ...
            private ObservableCollection<string> _submissionDocument = new ObservableCollection<string>();
            ...
            private void UpdateCursorPostion()
            {
                ...
                // 2 viene de la identacion que se añade al principio
            ...
            public int CurrentLine
            {
                ...
                set
                {
                    ...
                    {
                        _currentLine = value;
                        _currentCharacter = Math.Min(_submissionDocument[CurrentLine].Length, _currentCharacter);
                        UpdateCursorPostion();
                    }
                }
            }
        ...
        {
            var currentLine = document[view.CurrentLine];
            view.CurrentCharacter = currentLine.Length;
        }
